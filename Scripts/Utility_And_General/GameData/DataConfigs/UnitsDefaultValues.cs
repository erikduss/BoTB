...
namespace Erikduss
{
	public static class UnitsDefaultValues
	{
        ...
        public static UnitSettingsConfig Age01_Warrior = new UnitSettingsConfig()
        {
            ...
            unitName = "WARRIOR",
            unitDescription = "WARRIOR_DESCRIPTION",
            unitHealth = 15,
            unitArmour = 15,
            unitAttack = 7,
        ...
        public static UnitSettingsConfig Age01_Ranger = new UnitSettingsConfig()
        {
            ...
            unitAvailableInAge = Enums.Ages.AGE_01,
            unitName = "RANGER",
            unitDescription = "RANGER_DESCRIPTION",
            unitHealth = 20,
            unitArmour = 10,
            unitAttack = 9,
            unitMovementSpeed = 50,
        ...
        public static UnitSettingsConfig Age01_Assassin = new UnitSettingsConfig()
        {
            ...
            unitAvailableInAge = Enums.Ages.AGE_01,
            unitName = "ASSASSIN",
            unitDescription = "ASSASSIN_DESCRIPTION",
            unitHealth = 10,
            unitArmour = 10,
            unitAttack = 4,
        ...
        public static UnitSettingsConfig Age01_Enforcer = new UnitSettingsConfig()
        {
            ...
            unitAvailableInAge = Enums.Ages.AGE_01,
            unitName = "ENFORCER",
            unitDescription = "ENFORCER_DESCRIPTION",
            unitHealth = 30,
            unitArmour = 20,
            unitAttack = 1,
        ...
        public static UnitSettingsConfig Age01_Tank = new UnitSettingsConfig()
        {
            ...
            unitAvailableInAge = Enums.Ages.AGE_01,
            unitName = "TANK",
            unitDescription = "TANK_DESCRIPTION",
            unitHealth = 30,
            unitArmour = 30,
            unitAttack = 1,
        ...
        public static UnitSettingsConfig Age01_Mass_Healer = new UnitSettingsConfig()
        {
            ...
            unitAvailableInAge = Enums.Ages.AGE_01,
            unitName = "MASSHEALER",
            unitDescription = "MASSHEALER_DESCRIPTION",
            unitHealth = 10,
            unitArmour = 10,
            unitAttack = 0,
            unitMovementSpeed = 50,
        ...
        public static UnitSettingsConfig Age01_Battlemage = new UnitSettingsConfig()
        {
            ...
            unitAvailableInAge = Enums.Ages.AGE_01,
            unitName = "BATTLEMAGE",
            unitDescription = "BATTLEMAGE_DESCRIPTION",
            unitHealth = 20,
            unitArmour = 10,
            unitAttack = 4,
            unitMovementSpeed = 50,
        ...
        public static UnitSettingsConfig Age01_Archdruid = new UnitSettingsConfig()
        {
            ...
            unitAvailableInAge = Enums.Ages.AGE_01,
            unitName = "ARCHDRUID",
            unitDescription = "ARCHDRUID_DESCRIPTION",
            unitHealth = 50,
            unitArmour = 50,
            unitAttack = 15,
            unitMovementSpeed = 50,
        ...
        public static UnitSettingsConfig Age01_Shaman = new UnitSettingsConfig()
        {
            ...
            unitAvailableInAge = Enums.Ages.AGE_01,
            unitName = "SHAMAN",
            unitDescription = "SHAMAN_DESCRIPTION",
            unitHealth = 20,
            unitArmour = 10,
            unitAttack = 6,
            unitMovementSpeed = 50,
